 ...
 */
public abstract class Hilt_BarberDashboardFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BarberDashboardFragment() {
    super();
  }

  Hilt_BarberDashboardFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BarberDashboardFragment_GeneratedInjector) this.generatedComponent()).injectBarberDashboardFragment(UnsafeCasts.<BarberDashboardFragment>unsafeCast(this));
    }
  }
