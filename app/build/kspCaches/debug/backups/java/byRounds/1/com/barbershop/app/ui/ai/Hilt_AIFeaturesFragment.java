 ...
 */
public abstract class Hilt_AIFeaturesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AIFeaturesFragment() {
    super();
  }

  Hilt_AIFeaturesFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AIFeaturesFragment_GeneratedInjector) this.generatedComponent()).injectAIFeaturesFragment(UnsafeCasts.<AIFeaturesFragment>unsafeCast(this));
    }
  }
