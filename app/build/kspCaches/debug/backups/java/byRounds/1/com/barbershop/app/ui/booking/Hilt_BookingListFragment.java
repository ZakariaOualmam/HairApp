 ...
 */
public abstract class Hilt_BookingListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BookingListFragment() {
    super();
  }

  Hilt_BookingListFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BookingListFragment_GeneratedInjector) this.generatedComponent()).injectBookingListFragment(UnsafeCasts.<BookingListFragment>unsafeCast(this));
    }
  }
