 ...
 */
public abstract class Hilt_BookingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BookingFragment() {
    super();
  }

  Hilt_BookingFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BookingFragment_GeneratedInjector) this.generatedComponent()).injectBookingFragment(UnsafeCasts.<BookingFragment>unsafeCast(this));
    }
  }
