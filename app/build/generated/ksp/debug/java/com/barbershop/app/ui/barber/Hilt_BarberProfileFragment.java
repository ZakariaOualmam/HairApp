 ...
 */
public abstract class Hilt_BarberProfileFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BarberProfileFragment() {
    super();
  }

  Hilt_BarberProfileFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BarberProfileFragment_GeneratedInjector) this.generatedComponent()).injectBarberProfileFragment(UnsafeCasts.<BarberProfileFragment>unsafeCast(this));
    }
  }
