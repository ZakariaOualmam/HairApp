 ...
 */
public abstract class Hilt_HomeFragmentSimple extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_HomeFragmentSimple() {
    super();
  }

  Hilt_HomeFragmentSimple(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HomeFragmentSimple_GeneratedInjector) this.generatedComponent()).injectHomeFragmentSimple(UnsafeCasts.<HomeFragmentSimple>unsafeCast(this));
    }
  }
