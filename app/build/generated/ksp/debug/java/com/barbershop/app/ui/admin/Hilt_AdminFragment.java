 ...
 */
public abstract class Hilt_AdminFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AdminFragment_GeneratedInjector) this.generatedComponent()).injectAdminFragment(UnsafeCasts.<AdminFragment>unsafeCast(this));
    }
  }
